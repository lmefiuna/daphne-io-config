...
std::string configureAFEReg52(const AFE_NUMBER_t &afe, const REG_52_PARAMS_t &reg_52_params)
{
  ...
  Helpers::applyReg52Mask_LNAGain(reg_52_value, reg_52_params.lna_gain_db);
  Helpers::applyReg52Mask_LNAIntegratorEnable(reg_52_value, reg_52_params.lna_integrator_enable);
  Helpers::applyReg52Mask_LNAClampLevel(reg_52_value, reg_52_params.LNAClampLevel);
...
std::string configureAFEReg51(const AFE_NUMBER_t &afe, const REG_51_PARAMS_t &reg_51_params)
{
  ...
  Helpers::applyReg51Mask_PGAGain(reg_51_value, reg_51_params.pga_gain_db);
  Helpers::applyReg51Mask_PGAIntegratorEnable(reg_51_value, reg_51_params.pga_integrator_enable);
  Helpers::applyReg51Mask_PGAClampLevel(reg_51_value, reg_51_params.PGAClampLevel);
