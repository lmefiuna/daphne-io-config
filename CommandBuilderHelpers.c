...
void applyReg52Mask_LNAIntegratorEnable(uint16_t *regValue, const int enable) {
...
void applyReg52Mask_activeTerminationEnable(uint16_t *regValue, const int enable) {
...
void applyReg51Mask_PGAIntegratorEnable(uint16_t *regValue, const int enable) {
...
void applyReg51Mask_PGAClampLevel(
    uint16_t *regValue, const PGA_CLAMP_LEVEL_DBFS_t PGAClampLevel_dBFS) {
